...
var $__app_47_compiled_47_main__ = (function() {
  "use strict";
  var __moduleName = "app/compiled/main";
  angular.module('ae', ['ae.directives']).controller('AppController', function() {
    this.data = {test: 42};
  });
  angular.module('ae.directives', []).directive('classController', function() {
    var Controller = function Controller() {
      console.log('hello', this);
    };
    ($traceurRuntime.createClass)(Controller, {foo: function() {
